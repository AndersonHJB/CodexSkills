...
- 经典主题、随机主题、基础动作、正面全身、八角度、情绪包、分组拼图和全部拼图均可独立开启或关闭，省去不需要的生成；
...
默认全开会生成 369 张。若只需要原来的基础 72 张，可关闭正面全身、八角度和情绪包；若只想测试一个主题的完整系统，可关闭随机主题组，生成 41 张。详细开关模板请直接复制专属中文 README 中的示例。
